-- Script para corregir los datos de parámetros
-- Primero eliminar datos incorrectos si existen
DELETE FROM ge_parameters;

-- Reiniciar la secuencia
ALTER SEQUENCE ge_parameters_param_id_seq RESTART WITH 1;

-- Insertar parámetros principales para ISO 25010
INSERT INTO ge_parameters (param_standard_id, param_name, param_description, param_weight)
VALUES 
...
INSERT INTO ge_parameters (param_standard_id, param_name, param_description, param_weight, param_parent_id)
VALUES 
...
SELECT COUNT(*) as total_parameters FROM ge_parameters;
SELECT param_id, param_name, param_standard_id, param_parent_id FROM ge_parameters ORDER BY param_id;
